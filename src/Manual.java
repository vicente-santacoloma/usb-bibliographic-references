// Clase Manual hereda de Referencia
public class Manual extends Referencia {

	// Constructor de la clase
	protected Manual (String Anio, String Autor, String Id, String Titulo) {
	...
	public boolean cumpleCondicion (Condicion cond) { 
		...
		for (int i = 0; i<tokensBuscar.length-1; i=i+2) {
			...
			if (tokensBuscar[i].equals("Anio")) { 
				...
				v = (tokensBuscar[i+1].equals("Manual"));
			}
			else { 
				v = false; 
			}
